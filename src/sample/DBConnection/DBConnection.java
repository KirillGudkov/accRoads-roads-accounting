...
public class DBConnection {
    ...
    public ResultSet sendRequest (String first, String second, String third) throws Exception {
        ...
        ResultSet resultSet = statement.executeQuery("SELECT CROSSING.STATUS, CROSSING.DATE_BEGIN_OF_REPAIRS, CROSSING.DATE_END_OF_REPAIRS, CROSSING.TECHNICAL_CONDITION, CROSSING.COSMETIC_CONDITION " +
